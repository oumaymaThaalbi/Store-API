...
class ProductAction
{
    ...
    private function _dispatch()
    {
        ...
        $sql_dispatch = "SELECT p.*, 
                                IF (produit_lang_titreobjet IS NULL, produit_titreobjet, produit_lang_titreobjet),
                                IF (produit_lang_nom IS NULL, produit_nom, produit_lang_nom),
                                IF (produit_lang_description IS NULL, produit_description, produit_lang_description)
            FROM produit p
